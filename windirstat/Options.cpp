...
Setting<int> COptions::TreeMapGridMinimumArea(OptionsTreeMap, L"TreeMapGridMinimumArea", (CTreeMap::GetDefaults().GetGridMinimumAreaPercent()));
...
void COptions::SetTreeMapOptions(const CTreeMap::Options& options)
{
    ...
    TreeMapGridMinimumArea = TreeMapOptions.GetGridMinimumAreaPercent();
...
void COptions::PostProcessPersistedSettings()
{
    ...
    TreeMapOptions.SetGridMinimumAreaPercent(TreeMapGridMinimumArea);
