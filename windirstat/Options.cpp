...
Setting<int> COptions::TreeMapGridMinimumSize(OptionsTreeMap, L"TreeMapGridMinimumSize", (CTreeMap::GetDefaults().GetGridMinimumSize()));
...
void COptions::SetTreeMapOptions(const CTreeMap::Options& options)
{
    ...
    TreeMapGridMinimumSize = TreeMapOptions.GetGridMinimumSize();
...
void COptions::PostProcessPersistedSettings()
{
    ...
    TreeMapOptions.SetGridMinimumSize(TreeMapGridMinimumSize);
