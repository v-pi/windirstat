...
void CPageTreeMap::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_Text(pDX, IDC_STATICGRIDMINIMUMSIZE, m_sGridMinimumSize);
    DDX_Slider(pDX, IDC_GRIDMINIMUMSIZE, m_nGridMinimumSize);
...
void CPageTreeMap::UpdateOptions(const bool save)
{
    if (save)
    {
        ...
        m_options.SetGridMinimumSize(m_nGridMinimumSize);
    ...
    else
    {
        ...
        m_nGridMinimumSize = m_options.GetGridMinimumSize();
...
void CPageTreeMap::UpdateStatics()
{
    ...
    m_sGridMinimumSize.Format(L"%d px", m_nGridMinimumSize);
}
